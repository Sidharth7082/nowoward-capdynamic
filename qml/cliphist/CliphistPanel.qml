...
Item {
    ...
    function copySelected() {
        ...
        // Use the helper script: it decodes by id and sets the correct MIME
        // type for images (wl-copy -t image/png) instead of plain text.
        copyProc.command = ["sh", "-c", "\"$1\" \"$2\"", "--", root.scriptPath, entry.id];
